public class p16_TrabajandoEnteros {
    ...
    int num1 = 42;
    int num2 = 0x2A;//numero exadecimal
    int num3 = 0b00101010;//binario
    byte val1 = 120, val2 = 1;
    short horas = 24, dias = 9099;
    long ganancia = 9223372036854733307L;//L para tipo long

    //forma (string.format)
    System.out.print("\033[H\033[2J"); System.out.flush();
    System.out.println("\nUso de String.format para formateo de números enteros: ");
    System.out.println(String.format("num1 base decimal : %d",num1));//decimal
    System.out.println(String.format("num1 base octal : %o",num1));//octagonal
    System.out.println(String.format("num2 base hexadecimal : %x",num2));//hexadecimal
    System.out.println(String.format("La ganancia anual : %,d", ganancia));

    //forma 2 (integeger.toString)
