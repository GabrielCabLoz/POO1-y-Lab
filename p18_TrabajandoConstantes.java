public class p18_TrabajandoConstantes {
        ...
        static final double DESCUENTO = 0.10; //constante 
        static final int VELOCIDADLUZ = 30000;
        static final float TASA = 0.5f;
        static final byte SEPARADOR = 113;        public static void main(String[] args) {
        ...
        //El valor de las constantes no se modifican
        }
